...
layer parse_yolo(list *options, size_params params)
{
    ...
    float *class_weights = parse_yolo_class_weights(cw,classes);
    //++class_weights
    layer l = make_yolo_layer2(params.batch, params.w, params.h, num, total, mask, class_weights , classes, max_boxes);
